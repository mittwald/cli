...
export abstract class GeneratedDomainListDomainOwnerships<
  TItem extends Record<string, unknown>
> extends ListBaseCommand<
  typeof GeneratedDomainListDomainOwnerships,
  TItem,
  Response
> {
  ...
  public async getData(): Promise<Response> {
    ...
    } as Parameters<typeof this.apiClient.domain.listDomainOwnerships>[0]);
  }
