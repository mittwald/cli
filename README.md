...
* [`mw backup schedule delete [BACKUPSCHEDULEID]`](#mw-backup-schedule-delete-backupscheduleid)
* [`mw backup schedule list`](#mw-backup-schedule-list)
* [`mw backup schedule update [SCHEDULEID]`](#mw-backup-schedule-update-scheduleid)
...
FLAGS
  ...
  -q, --quiet                suppress process output and only display a machine-readable summary.
      ...
      --schedule=<value>     (required) Define the schedule itself
      --ttl=<value>          (required) Define the backup storage period in days, for through this schedule created
                             backups
...
```
USAGE
  $ mw backup schedule delete [BACKUPSCHEDULEID] [-q] [-f] [--backupScheduleId <value>]

ARGUMENTS
  BACKUPSCHEDULEID  ID of schedule to delete

FLAGS
  -f, --force                     Do not ask for confirmation
  -q, --quiet                     suppress process output and only display a machine-readable summary.
      --backupScheduleId=<value>  ID of backup schedule to delete
...
## `mw backup schedule update [SCHEDULEID]`

Update an existing backup schedule

```
USAGE
  $ mw backup schedule update [SCHEDULEID] [-q] [--scheduleId <value>] [--description <value>] [--schedule <value>] [--ttl
    <value>]

ARGUMENTS
  SCHEDULEID  Define the backup schedule that is to be updated

FLAGS
  -q, --quiet                suppress process output and only display a machine-readable summary.
      --description=<value>  Set the description for the backup schedule
      --schedule=<value>     Define the schedule itself
      --scheduleId=<value>   Define the backup schedule that is to be updated
