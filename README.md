...
- [`mw` — the mittwald command-line tool](#mw--the-mittwald-command-line-tool)
  - [Synposis](#synposis)
  - [Getting started](#getting-started)
    - [Installation](#installation)
      - [macOS, using Homebrew](#macos-using-homebrew)
      - [Windows, using the Installer](#windows-using-the-installer)
      - [Any OS, using Node.js+NPM](#any-os-using-nodejsnpm)
      - [Any OS, using Docker](#any-os-using-docker)
    - [Authentication](#authentication)
    - [Setting up shell autocompletion](#setting-up-shell-autocompletion)
...
_See code:
[@oclif/plugin-help](https://github.com/oclif/plugin-help/blob/v6.0.9/src/commands/help.ts)_
...
_See code:
[@oclif/plugin-update](https://github.com/oclif/plugin-update/blob/v4.1.7/src/commands/update.ts)_
