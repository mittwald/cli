...
```
USAGE
  $ mw app install humhub --version <value> [-p <value>] [-q] [--host <value>] [--site-title <value>] [--admin-user
    <value>] [--admin-email <value>] [--admin-pass <value>] [--admin-firstname <value>] [--admin-lastname <value>] [-w]
    [--wait-timeout <value>]
