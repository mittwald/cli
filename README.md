...
* [`mw domain ownership verify HOSTNAME`](#mw-domain-ownership-verify-hostname)
...
## `mw domain ownership verify HOSTNAME`

Verify domain ownership

```
USAGE
  $ mw domain ownership verify HOSTNAME [-q] [-p <value>]

ARGUMENTS
  HOSTNAME  Name of the domain to verify
